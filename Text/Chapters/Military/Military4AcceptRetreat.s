...
think any of us blame you.[A][FarLeft][LoadAdeline]
...
Adeline! It's not worth it! I think what[NL]
[Tact] did was very fair. I'm grateful[A][NL]
for being able to live another day.[A]
[Left]Hmph.[A][FarRight][ClearFace][LoadJasper]
...
Corporals [Tact] and Adeline. I received[NL]
word from Vice Captain Blaine about[A][NL]
your failure on the front lines.[A]
[FarRight][Tact] had us abandon the post, sir![A]
...
However, your fellow Corporal seems to[NL]
disagree. All due respect, [Tact], but[A][NL]
Adeline has held the position longer,[NL]
so it was not necessarily your[A][NL]
decision to make to begin with.[A]
[FarRight]Thank you s-[A]
[MidLeft]Even so, Adeline, you follow Jurgen, even[NL]
when his orders are questionable. I[A][NL]
hesitate to pass judgment[NL]
based solely on the words of[A][NL]
two Corporals. Perhaps Private[NL]
...
harsh, but he is effective. A large part of[NL]
the Dragon Brigade has been pulled to the[A][NL]
front lines, so we're glad to have you[NL]
here. Corporal [Tact], I want you[A][NL]
and your squadron to stay here in the[NL]
capital for now. We are sadly lacking[A][NL]
in defenses here presently, and I'd like[NL]
to have a few more soliders in the city.[A]
[Left]So that means... We aren't getting[NL]
punished for abandoning our posts?[A]
[FarLeft]Not at all. I value my soldiers' lives.[NL]
I'm glad you made it out. Get[A][NL]
some rest. Corporal Adeline,[NL]
...
## Military4AcceptRetreatSchemingText
[ConversationText]
[MidLeft][LoadPlayer][MidRight][LoadJasper]
Hey [Tact]? You okay?
[MidLeft]Huh? Oh hey Jasper. Yeah I'm fine.
[MidRight]It's not like you to be so distracted. Shouldn't you be getting some rest?
[MidLeft]I was just thinking... This military is such a mess. I mean, Captain Jurgen was free to do whatever he wanted, but General Rex just kind of... ignored it.
[MidRight]Derek did point out the lack of communication.
[MidLeft]Right? It seems like no way to operate. Maybe there are bigger problems here.
[MidRight]Like what?
[MidLeft]Is it fair to our soldiers if our commanders don't care and bicker back and forth about what to do with our lives?
[MidRight]I suppose not... How would we fix that?
[MidLeft]I don't know. Move up in the ranks?
[MidRight]Change the system from the inside... Yeah. Makes sense to me.
[MidLeft]We'll have to do our best to excel in this war.
[MidRight]Right. We've got this. I agree with you. Something has to change.
[MidLeft]We should tell the others at some point.
[MidRight]I'd be careful. Don't want anyone to think you're trying to betray Cesaria.
[MidLeft]Don't worry. Get some rest Jasper.
[MidRight]I will. Don't stay up too long. You need your rest too.[ClearFace]
[MidLeft]I've got it. ... He's gone. None of us are going to move up in the ranks unless someone in a high rank is removed... Hm... No, I can't think that way. I need some rest.[X]
...
What!? Dammit! Where's[NL]
the Dragon Brigade?[A]
...
[MidLeft]Let's get to the Emperor's room.[NL]
We have to make sure he's okay![A][X]

## Military4AcceptRetreatInCorridorsText
[FarLeft][LoadLeyos][Left][LoadAdeline][MidRight][LoadPlayer]
Adeline! You're here! What's the status?[A]
...
## Military4AcceptRetreatStartBattleText
[FarLeft][LoadLeyos][Left][LoadZaheva][MidRight][LoadPlayer]
So dark...[A]
[FarLeft]A classic Shizonian tactic.[NL]
I expected no less.[A]
[Left]And I thought this interior was[NL]
dark with the torches lit.[A]
[MidRight]Damn Shizonians.[A]
[Left][Tact], we need to stick together[NL]
if we want to make it through the[A][NL]
night. If they disorganize us[NL]
and draw us too far forward,[A][NL]
they win. Let's tread carefully![A][X]
...
[MidRight]Corporal [Tact]. I'm aiding the Dragon[NL]
...
myself under your command for[A][NL]
now, [Tact]. I would never[NL]
forgive myself if something[A][NL]
happened to the Emperor.[A]
...
[FarLeft][LoadArya]
I'm sorry, Xexim...[A][2NL]
I hope you can finish[NL]
the mission...[A][X]

## Military4AcceptRetreatTactAryaBattleText
[FarRight][LoadPlayer]
I won't let you[NL]
harm the Emperor![A][ClearFace]
[FarLeft][LoadArya]
You might not be able[NL]
to stop that.[A][ClearFace]
[FarRight][LoadPlayer]
What's your problem? You[NL]
aren't what I expected[A][NL]
from a Shizonian. These[NL]
tactics are so aggressive...[A][ClearFace]
[FarLeft][LoadArya]
...
dead or fleeing. Should we make[NL]
...
[FarRight]What? I'll stay back here with[NL]
Adeline and Remus just to[A][NL]
make sure all is good with the[NL]
Emperor. You have to go![A][Right][LoadYvette]
...
to your aid. I've made sure of that.[A][NL]
I'm still a master of my craft.[A]
...
pull out. 'Til next time.[A][NL]
Keep one eye open.[Wink][NL]
We will finish this.[A][CloseSpeech][MoveFarFarLeft][.......][Right][MoveMidLeft][....][ClearFace][LoadRex]
Damn, he got away...[A]
...
[MidLeft][LoadPlayer][FarRight][LoadEmperor][Right][LoadLeyos]
You're the Corporal that[NL]
led the forces outside?[A]
[MidLeft]Yes, that was me.[A]
[Right]Hm. Good work. The Emperor[NL]
wants to thank you.[A]
[MidLeft]What?[A]
[FarRight]Leyos is correct. Because of your[NL]
efforts outside, I survived. [Smile]I doubt[A][NL]
Leyos would have been able to[NL]
hold them all off on his own[A][NL]
had they gotten inside...[A]
[Right][Smile]All due respect, my lord...[A]
[FarRight]It was a joke, Leyos, [Smile]but regardless,[NL]
I am in your debt, Corporal.[A]
[MidLeft]It was simply my[NL]
duty, my lord. I-[A][CloseSpeech][....]
[Events]
[MoveLeft][FarLeft][LoadSoldier2]
Corporal [Tact]![A][CloseSpeech][Right][ClearFace][Smile][Left][MoveRight][ClearFace][LoadPlayer]
What is it?[A]
[FarLeft]General Rex, he... he's dead![A][Left][LoadYvette]
What!?[A]
[Events]
[FarLeft]It seems that he was the real target all[NL]
...
[FarRight]It can't be...[A]
[Right]Damn it all...[A]
[Left]We'll have to call back the Captains.[NL]
...
[Left]Right...[....] I should have returned[NL]
sooner...[.....] We can't afford to just[NL]
get distracted by this...[A]
[Right]Exactly. Arcanae would be foolish not[NL]
to use this opening. We'll need to be[A][NL]
in our best shape. I'm sorry...[A][Left][ClearFace][LoadJasper]
What for?[A]
[Right]I should have had us check on the[NL]
General. This is my fault.[A]
[Left]You had no way of knowing.[A]
[Right][TMM]...[....][TMM] Yeah...[.....] I suppose you're right.[A][FarLeft][ClearFace][LoadLeyos]
Your friend speaks the truth, [Tact].[NL]
Emperor, what do you wish me to do?[A][NL]
I can't take command as is, I know precious[NL]
little about current deployments...[A]
[FarRight]We will have to wait for[NL]
Captain Zalius to return...[A][NL]
Send word to him immediately.[A]
[FarLeft]Yes, my lord.[A][ClearFace]
[FarRight][Tact].[A][CloseSpeech][Left][MoveFarLeft][Right][MoveLeft][ClearFace][LoadPlayer][FarRight]I am going to need strong[NL]
leaders in the future. Rex was a dear[A][NL]
friend and an outstanding commander... I[NL]
would be honored if you would help[A][NL]
take up those reigns and be a[NL]
Sergeant within the Dragon Brigade.[A]
[Left]My lord... I... accept. Thank[NL]
you very much. I won't[A][NL]
let you down again.[A]
[FarRight]You haven't let me down. Now get some rest.[NL]
Captain Zalius will give you orders in the[A][NL]
morning. I must continue discussion with[NL]
Leyos about this. You are dismissed.[A][ClearFace][......]
[FarLeft]Best we can do now is get some rest,[NL]
[Tact]. You first. Derek and[A][NL]
I can keep watch for a bit.[A]
[Left]Thanks, Jasper. I think I need it...[A][X]
...
## Military4AcceptRetreatStairHelpText
Use these stairs to[NL]
reach the chests.[A][X]
