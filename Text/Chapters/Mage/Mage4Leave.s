...
Zaheva: Hmph.
Arya: Not to interrupt, but I scouted a bit ahead and... we may have a problem.

*cut to battlefield where the Cesarian and Arcanian armies are engaged*
“The Devoted”
Avatar: That's-
...
Avatar: Right. We'll have to move quickly... Let's go!

Player Phase: Chinese Tea
Enemy Phase: Puppet Ganon
(for now)

*talk to Blaine w/ Tact*
...
Zaheva: Only if you can avoid finding yourself impaled by my sword...

Generic: You all aren't Cesarians... Why have you entered this battlefield!? Grr... I'll deal with you myself!
Death: I've... Failed...

*escape dialogue* (chapter ends when any individual escapes)
Arya: Let's go, [Tact]! No time to dally!
Zaheva: I'm moving ahead. Catch up quickly.
Ajax: We made it to the other side, let's go!
Xena: Don't fall behind, [Tact], we have to keep moving!
Avatar: We made it through the skirmish... On to Bacrun!

*if chapter won by defeating boss*
“Heaven's Rock Seat”
...
Xena: Thank you, Vice-Captain, even if we cannot come to an agreement, simply listening to our plight means a lot.
...
Ajax: We're getting very near to Bacrun. Hopefully once we get there, we can find some way to escape from Arcanae even further, either to Haedric, Altia, or the far northern parts of Cesaria. For now, I think we should take a brief break. Get some rest, we'll move out again in a few hours.
