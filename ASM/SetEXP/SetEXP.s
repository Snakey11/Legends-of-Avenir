...
@ -D__USES_INITFINI__ SetEXP.c -mcpu=arm7tdmi -mthumb -mthumb-interwork
@ -mtune=arm7tdmi -mlong-calls -march=armv4t -auxbase-strip SetEXP.s -Os
@ -Wall -fverbose-asm
...
@ -msched-prolog -mthumb -mthumb-interwork -mvectorize-with-neon-quad
	...
	.thumb_func
	.fpu softvfp
	.type	SetEXP, %function
SetEXP:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	push	{r4, lr}	@
@ SetEXP.c:9: 	Unit* unit = GetUnitByCharId(gMemorySlots[1]);
	ldr	r4, .L2	@ tmp115,
@ SetEXP.c:9: 	Unit* unit = GetUnitByCharId(gMemorySlots[1]);
	ldr	r3, [r4, #4]	@ tmp124, gMemorySlots
	lsls	r0, r3, #24	@ tmp118, tmp124,
	lsrs	r0, r0, #24	@ tmp118, tmp118,
	ldr	r3, .L2+4	@ tmp120,
	bl	.L4		@
@ SetEXP.c:10: 	unit->exp = gMemorySlots[2];
	ldr	r3, [r4, #8]	@ gMemorySlots, gMemorySlots
@ SetEXP.c:11: }
	@ sp needed	@
@ SetEXP.c:10: 	unit->exp = gMemorySlots[2];
	strb	r3, [r0, #9]	@ gMemorySlots, unit_7->exp
@ SetEXP.c:11: }
	pop	{r4}
	pop	{r0}
	bx	r0
