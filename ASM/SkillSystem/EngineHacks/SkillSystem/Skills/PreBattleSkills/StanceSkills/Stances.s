...
@Bracing Stance- +2 res/def
@Darting Stance- +3 Speed 
@Fierce Stance - +3 Attack 
@Kestrel Stance- +2 atk/spd
@Mirror Stance- +2 atk/res
@Steady Stance- +3 def
@Sturdy Stance- +2 atk/def
@Ready Stance - +2 spd/def
@Swift Stance- +2 spd/res
@Warding Stance- +3 res
