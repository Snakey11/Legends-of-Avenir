...
.equ GetUnitEquippedItem, 0x8016B29

.global ClassPlatformDisplayLoop
.type ClassPlatformDisplayLoop, %function
ClassPlatformDisplayLoop:
                        push    {r4-r7,r14}
    ...
    /* 080CD0F8 (T) */  add     r0,sp,#0x4
						ldrh	r2,[r0,#0x1E] @ Instead of getting the equipped item, just always get the first item.
    ...
    /* 080CD14A (T) */  ldr     r3, =#0x80CD47C
						mov 	lr, r3
						mov		r3, #0x3A // Height of the battle sprite.
						@ldrb	r3, [ r3 ]
						.short 0xF800
