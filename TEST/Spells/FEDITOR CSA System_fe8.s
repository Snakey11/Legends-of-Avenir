...
.global CSAEngine_Dim
.type CSAEngine_Dim, %function
Dim_Constructor:
CSAEngine_Dim:
push  {r4-r6, lr}   @
mov r5, r0    @
...
cmp r6, #0x0    @@@ i corrected it anyway
beq       NO_SUB
sub r1, #0x2    @
NO_SUB:
ldrb  r1, [r1]    @
...
@@ the following section stretches the bg. No need for this lol
 ...
 ldr r0,     H_BLANK_BS_1
 ldr r1,     SCREEN_STRETCH_PC_1
 str r1, [r0]    @Screen stretching IRQ set
pop {r0}      @
cmp r0, #0x0    @
bne       super_with_dim
b       super_without_dim
.global CSAEngine_NoDim
.type CSAEngine_NoDim, %function
No_Dim_Constructor:
CSAEngine_NoDim:
push  {r4-r6, lr}   @
mov r5, r0    @
